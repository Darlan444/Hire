...
// Faz o upload da imagem pro diretório
$extensao_permitida = array('jpg', 'jpeg', 'JPG', 'JPEG', 'Jpg', 'Jpeg');
    ...
    foreach($_FILES['foto_f']['name'] as $key_image=>$val_image){
        ...
        if (mysqli_affected_rows($mysql_db) != 0) {
            ...
            echo "Você colocou arquivos não suportados pelo sistema! Arquivos permitidos: <b>.jpg</b> e <b>.jpeg</b>.";?><br>
            <a href="anunciar.php"> Voltar </a>
            <?php
        }
    }
